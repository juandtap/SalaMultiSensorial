...
template = env.get_template('sesion_report_template.html')
...
student_info = {
    ...
    'dicapacidad': student.discapacidad,
...
output = template.render(esttudiante=student_info,sesion=student_sesion,modulos_trabajados=modulos)
