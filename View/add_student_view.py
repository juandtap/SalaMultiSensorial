...
class Ui_Add_student(object):
    def setupUi(self, Add_student):
        ...
        self.label.setGeometry(QtCore.QRect(510, 40, 260, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
...
"}")
        ...
        self.dateEdit_estudiante.setMinimumDate(QtCore.QDate(2005, 1, 1))
        self.dateEdit_estudiante.setDate(QtCore.QDate(2013,1,1))
