...
class Ui_Add_student(object):
    def setupUi(self, Add_student):
        ...
        self.label.setGeometry(QtCore.QRect(520, 30, 241, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.pushButton_save.setGeometry(QtCore.QRect(520, 560, 111, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
...
"border-radius: 10px;")
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(630, 90, 631, 81))
