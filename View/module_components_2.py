...
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QComboBox, QGraphicsScene, QGraphicsRectItem
...
class ModuleVumeter(QWidget):
    def __init__(self, sesion, com_port):
        ...
        self.ui_vum.pushButton_start.clicked.connect(self.set_level)
